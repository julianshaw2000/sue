...
var outputFilePath = path.join(__dirname, 'valid_emails.txt');
// Email validation regex
var emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
// Function to filter valid email addresses
function filterValidEmails() {
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, validEmails, _a, rl_1, rl_1_1, line, e_1_1, err_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 12:
                    ...
                    console.log("Valid emails written to: ".concat(outputFilePath));
                    return [3 /*break*/, 14];
                case 13:
                    err_1 = _e.sent();
                    console.error('Error processing files:', err_1);
                    return [3 /*break*/, 14];
